...
import streaming.service.PersonneDAO;
...
public class PersonneServiceCRUDTest {
    ...
    @Before
    public void ajouterPersonne() throws ClassNotFoundException, SQLException, DatabaseUnitException, FileNotFoundException {
        

        // Connexion DB
        Class driverClass = Class.forName("org.apache.derby.jdbc.ClientDriver");
        Connection jdbcConnection = DriverManager.getConnection(
                "jdbc:derby://localhost:1527/Simple3", "app", "app");
    ...
    @Test
    public void findOneByPrenomAndNomOK(){
        
        Assert.assertNotNull(crud.findOneByPrenomAndNom("SOHAYB", "KHAOULANI"));
    }
}
